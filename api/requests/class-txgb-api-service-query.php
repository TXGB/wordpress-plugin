 ...
 */
class TXGB_API_Service_Query implements TXGB_API_Request
{
	protected $type;
	...
	protected $with_products = false;
	protected $with_provider = false;
	...
	{
		$this->with_products = true;

		return $this;
	}

	public function with_provider()
	{
		$this->with_provider = true;

		return $this;
	}

	public function with_short_content()
	{
		$this->output = array(
	...
	public function to_request_args()
	{
		...
		if ($this->with_provider) {
			$args['EntitySearch_RQ']['Output']['Parents'] = array(
				'Filter' => array(
					'Type' => 'Provider',
					'MustBeInAdCampaign' => false,
					'MustBeInDealCampaign' => false,
